...
import Paper from './componentes/export/matrimonio/paper';
import iglesiaApi from '../../api/iglesiaApi';

export const ExportMatrimonio = () => {
...
//     //setHasData(true)
//     var mensaje = "";
//     if (getbautismo.data.msg == "no perms")
//     {
...
//   }, [adDocumentos])
  useEffect(() => {
      if (window.location.href.includes('/ExportMatrimonio?View=true&') === true) {
          setIsClient(true)
        //   setHasData(false)
        //   const value = window.location.href.search('&')
        //   const trim = window.location.href.slice(value + 1)
        //   RequestData(trim)
          window.history.replaceState(null, '', '/ExportMatrimonio')
        } else {
