...
import Paper from './componentes/export/confirmacion/paper';
import iglesiaApi from '../../api/iglesiaApi';

export const ExportConfirmacion = () => {
  ...
  useEffect(() => {
      if (window.location.href.includes('/ExportConfirmacion?View=true&') === true) {
          setIsClient(true)
          setHasData(false)
